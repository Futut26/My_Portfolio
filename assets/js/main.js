...
document.getElementById("downloadButton").addEventListener("click", function() {
  var fileURL = "../resume.pdf"; // Ganti dengan path direktori dan nama file PDF Anda
  ...
  xhr.onload = function() {
      if (xhr.status === 200) {
          ...
          a.href = url;
          a.download = "Putut-Budiutomo-Resume.pdf"; // Ganti dengan nama file yang ingin digunakan saat diunduh
...
document.getElementById("emailForm").addEventListener("submit", function(event) {
  ...
  emailjs.send("service_063sq79", "template_5fv45jh", {
      from_name: name,
      from_email: email,
      subject: subject,
      message: message
  ...
  .then(function(response) {
      ...
      errorMessage.innerHTML = "Sorry, an error occurred while sending your message.";
  });
});
